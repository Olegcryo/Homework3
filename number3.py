...
rus = {1:'АВЕИНОРСТ',
    ...
    8:'ШЭЮ',
    10:'ФЩЪ'}
n = int(input('Введите 0, если используете английскую раскладку , или же 1 , если русскую --> '))
word = input('Введите слово --> ').upper()
if n == 0:
   print('Введенное слово стоит', sum([k for i in word for k, v in en.items() if i in v]), 'очков')
elif n == 1:
	print('Введенное слово стоит', sum([k for i in word for k, v in rus.items() if i in v]), 'очков')
else:
    print('Допущена ошибка. Попробуйте ввести слово заного.')